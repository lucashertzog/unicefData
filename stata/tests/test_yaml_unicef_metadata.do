...
* Define test result program with rclass
capture program drop test_result
program define test_result, rclass
...
local ++total_tests
cap yaml read using "`metadata_path'/indicators.yaml"
if _rc == 0 {
    test_result, test_num("1a") test_name("Read indicators.yaml") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("1a") test_name("Read indicators.yaml") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
if `test_pass' {
    test_result, test_num("1b") test_name("Verify metadata_version = 1.0") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("1b") test_name("Verify metadata_version = 1.0") result("FAIL") ///
...
local ++total_tests
yaml clear
cap yaml read using "`metadata_path'/codelists.yaml"
if _rc == 0 {
    test_result, test_num("1c") test_name("Read codelists.yaml") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("1c") test_name("Read codelists.yaml") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml list children
if _rc == 0 {
    test_result, test_num("2a") test_name("List root children") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("2a") test_name("List root children") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml list indicators, children
if _rc == 0 {
    test_result, test_num("2b") test_name("List indicators children") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("2b") test_name("List indicators children") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml list indicators_CME_MRM0, children
if _rc == 0 {
    test_result, test_num("2c") test_name("Navigate indicators.CME_MRM0") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("2c") test_name("Navigate indicators.CME_MRM0") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml get indicators_CME_MRM0, attributes(name)
local test_pass = 0
if _rc == 0 {
...
if `test_pass' {
    test_result, test_num("2d") test_name("Get CME_MRM0.name") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("2d") test_name("Get CME_MRM0.name") result("FAIL") ///
...
yaml clear
yaml read using "`metadata_path'/dataflows.yaml"
...
if `list_items' > 0 | `total_rows' > 5 {
    test_result, test_num("3a") test_name("YAML structure loaded correctly") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("3a") test_name("YAML structure loaded correctly") result("FAIL") ///
...
if `test_pass' {
    test_result, test_num("3b") test_name("Dataflows has expected structure") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("3b") test_name("Dataflows has expected structure") result("FAIL") ///
...
local ++total_tests
yaml clear
cap yaml read using "`metadata_path'/indicators.yaml", frame(indicators_meta)
if _rc == 0 {
    test_result, test_num("4a") test_name("Load indicators into named frame") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("4a") test_name("Load indicators into named frame") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml read using "`metadata_path'/codelists.yaml", frame(codelists_meta)
if _rc == 0 {
    test_result, test_num("4b") test_name("Load codelists into named frame") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("4b") test_name("Load codelists into named frame") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
cap yaml frames
if _rc == 0 {
    test_result, test_num("4c") test_name("List yaml frames") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("4c") test_name("List yaml frames") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml get metadata_version, frame(indicators_meta)
if _rc == 0 {
    test_result, test_num("4d") test_name("Get value from specific frame") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("4d") test_name("Get value from specific frame") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
if r(N) > 0 {
    test_result, test_num("5a") test_name("Indicators has indicators section") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("5a") test_name("Indicators has indicators section") result("FAIL") ///
...
if `test_pass' {
    test_result, test_num("5b") test_name("Indicators has total_indicators") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("5b") test_name("Indicators has total_indicators") result("FAIL") ///
...
local ++total_tests
cap yaml write using "`test_output_path'/indicators_roundtrip.yaml", replace
if _rc == 0 {
    test_result, test_num("6a") test_name("Write indicators to new file") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("6a") test_name("Write indicators to new file") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
cap {
    yaml clear
    yaml read using "`test_output_path'/indicators_roundtrip.yaml"
...
if `test_pass' {
    test_result, test_num("6b") test_name("Round-trip preserves indicator keys") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("6b") test_name("Round-trip preserves indicator keys") result("FAIL") ///
...
if _rc != 0 {
    test_result, test_num("7a") test_name("Error on non-existent file") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("7a") test_name("Error on non-existent file") result("FAIL") ///
...
yaml clear
yaml read using "`metadata_path'/indicators.yaml"
cap yaml list children, parent(nonexistent.path.here)
* This should either error or return empty - both are acceptable
test_result, test_num("7b") test_name("Handle invalid parent path") result("PASS")
local ++passed_tests
...
local ++total_tests
cap yaml validate, required(metadata_version indicators)
if _rc == 0 {
    test_result, test_num("8a") test_name("Validate existing required keys") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("8a") test_name("Validate existing required keys") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
if _rc != 0 {
    test_result, test_num("8b") test_name("Validate catches missing key") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("8b") test_name("Validate catches missing key") result("FAIL") ///
...
local ++total_tests
cap yaml validate, types(metadata_version:string)
if _rc == 0 {
    test_result, test_num("8c") test_name("Type validation (string)") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("8c") test_name("Type validation (string)") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
...
local ++total_tests
cap yaml validate, required(metadata_version) types(metadata_version:string)
if _rc == 0 {
    test_result, test_num("8d") test_name("Combined required + types validation") result("PASS")
    local ++passed_tests
}
else {
    test_result, test_num("8d") test_name("Combined required + types validation") result("FAIL") ///
        detail("Return code: `=_rc'")
    local ++failed_tests
}
